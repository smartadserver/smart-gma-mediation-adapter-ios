...
class SASGMAAdNetworkExtras: NSObject, AdNetworkExtras {
...
class SASGMAUtils {
    ...
    static func adapterVersion() -> VersionNumber {
        return VersionNumber.init(majorVersion: SASImplementationInfo_MediationAdapterVersion_Major,
    ...
    static func adSDKVersion() -> VersionNumber {
        ...
        return VersionNumber.init(majorVersion: majorVersion, minorVersion: minorVersion, patchVersion: patchVersion)
    }
    
    static func placementWith(adConfiguration: MediationAdConfiguration) -> SASAdPlacement? {
        ...
        SASConfiguration.shared.secondaryImplementationInfo = SASSecondaryImplementationInfo(primarySDKName: SASImplementationInfo_PrimarySDKName,
                                                                                             primarySDKVersion: string(for: MobileAds.shared.versionNumber),
    ...
    static func placementWith(serverParameter: String?, request: CustomEventRequest?, extras: SASGMAAdNetworkExtras?) -> SASAdPlacement? {
